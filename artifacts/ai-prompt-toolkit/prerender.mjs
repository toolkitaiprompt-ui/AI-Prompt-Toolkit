...
const routes = [
  // ── Static pages ──
  { path: "/", title: "Free AI Prompt Tools for Everyone | AI Prompt Toolkit",
    desc: "9 free in-browser AI prompt tools — format, validate, extract, optimize. JSON schema, token estimator, prompt converter & persona builder." },
