...
function ToolsDirectoryPage() {
  return (
    ...
    >
      {/* AD: 728x90 top banner — sab screens */}
      <AdsterraBanner size="728x90" className="mb-8" />
...
function BlogPage() {
  return (
    ...
    >
      {/* AD: 320x50 mobile banner + 728x90 — sab screens */}
...
function BlogPostPage() {
  ...
  return (
    <SectionShell title={post.seoTitle} description={post.metaDescription} keywords={`${post.category}, Prompt Engineering, AI Prompt Toolkit`}>
      <div className="space-y-6">
        {/* AD: 728x90 top banner — sab screens */}
        <AdsterraBanner size="728x90" className="mb-2" />
        {/* AD: 320x50 mobile banner — sab screens */}
        ...
        <div className="grid gap-10 lg:grid-cols-[2fr_360px]">
          <article className="space-y-8">
            {/* AD: 728x90 in-article — sab screens */}
            <AdsterraBanner size="728x90" />
            {/* AD: 320x50 in-article — sab screens */}
            <AdsterraBanner size="320x50" />
            {(() => {
            ...
            {/* AD: 300x250 after article — sab screens */}
            <div className="my-6">
              <AdsterraBanner size="300x250" />
            </div>
          </article>
          ...
          <aside className="space-y-6 rounded-3xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900/70">
            {/* AD: 160x600 sidebar — sab screens */}
            <AdsterraBanner size="160x600" />
            {/* AD: 160x300 sidebar — sab screens */}
            <AdsterraBanner size="160x300" />
            {/* AD: 300x250 sidebar — sab screens */}
            <AdsterraBanner size="300x250" />
