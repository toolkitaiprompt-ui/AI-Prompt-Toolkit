...
function HomePage() {
 ...
 10 free tools — variable extraction, JSON schema generation, validation, formatting, cleaning, token estimation, Prompt Converter, Persona Builder, Prompt Comparison, and advanced optimization. No sign-up required.
 </p>
...
function ToolsDirectoryPage() {
 ...
 description="Browse the best free AI tools for prompt engineering — variable extractor, JSON schema generator, JSON validator, prompt formatter, cleaner, token estimator, converter, persona builder, comparison & optimizer."
...
function AboutPage() {
 ...
 <li><strong className="text-white">Prompt Comparison Tool</strong> — Compare two prompts side by side with detailed metrics.</li>
