...
const TokenEstimatorPreview = () => (
  <div className="space-y-2 text-[11px]">
    <div className="flex justify-between">
      ...
      <span className="text-amber-300 font-semibold">2,048</span>
    </div>
    <div className="flex justify-between">
      <span className="text-slate-400">Words:</span>
      <span className="text-amber-300 font-semibold">256</span>
    </div>
    <div className="flex justify-between">
      <span className="text-slate-400">Tokens:</span>
      <span className="text-amber-300 font-semibold">512</span>
    </div>
  </div>
);
...
export default function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative space-y-4">
          <div className="flex items-start justify-between">
            <div className="flex h-14 w-14 items-center justify-center rounded-[12px] bg-gradient-to-br from-slate-900 to-slate-950 border border-white/10 group-hover:border-amber-400/30 transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-amber-500/20">
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold tracking-tight text-white group-hover:text-amber-200 transition-colors">
              {tool.title}
            </h3>
      ...
      <div className="absolute inset-x-0 bottom-0 h-[1px] bg-gradient-to-r from-transparent via-amber-500/0 to-transparent opacity-0 transition-opacity duration-300 group-hover:via-amber-500/60 group-hover:opacity-100" />
    </motion.div>
  );
}
