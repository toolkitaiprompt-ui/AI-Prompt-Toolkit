...
const DEFAULT_SEO: SeoData = {
  ...
  description:
    "Best free AI tools for everyone — 16 prompt engineering tools for building, formatting, validating, debugging, optimizing, securing, and translating prompts. No sign-up, 100% in-browser.",
  keywords:
...
const SEO_MAP: Record<string, SeoData> = {
  ...
  "/": {
    title: "Best Free AI Tools for Everyone | AI Prompt Engineering",
    description:
      "Best free AI tools for everyone — 16 prompt engineering tools for building, formatting, validating, debugging, optimizing, securing, and translating prompts. JSON schema, token estimator, mega prompt builder, debugger & more.",
    keywords:
  ...
  "/tools": {
    ...
    description:
      "Browse 16 best free AI tools for prompt engineering — variable extractor, JSON schema generator, JSON validator, prompt formatter, cleaner, token estimator, converter, persona builder, optimizer, mega prompt builder, debugger, security scanner, chain builder, translator, and API request builder.",
    keywords:
  ...
  "/changelog": {
    ...
    keywords:
      "AI Prompt Toolkit Changelog, Updates, New Features, Version History, AI Tools Updates, Prompt Engineering Tools",
  },
  ...
  "/tools/prompt-chain-builder": {
    title: "Free Prompt Chain Builder — Sequential Prompt Chains | AI World Hub",
    description:
...
export function getSeoForPath(pathname: string): SeoData {
  ...
  // Prompt role pages — /prompts/:role
  if (pathname.startsWith("/prompts/")) {
    return {
      title: "AI Prompts by Role — Ready-to-Use Prompt Templates | AI World Hub",
      description:
        "Browse role-based AI prompt templates — ready to copy, customize, and use with ChatGPT, Claude, Gemini, and any AI model. Free prompt library.",
