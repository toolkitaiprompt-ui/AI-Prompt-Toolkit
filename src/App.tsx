    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#e2e8f0] w-full">
      ...
      <main className="w-full">
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <LazyPromptOptimizer
                ...
                description="Free AI prompt optimizer: paste any prompt, and get a clearer, better-structured version with role, tone, and format added in one click. 100% in-browser, private, no signup — for ChatGPT, Claude, and Gemini users."
          ...
          <Route path="/tools/mega-prompt-builder" element={<LazyMegaPromptBuilder title="Mega Prompt Builder" toolSlug="mega-prompt-builder" description="Build complete mega prompts with a free 8-step wizard — role, task, context, audience, format, tone, constraints, and examples. Copy the finished prompt in one click. Private, in-browser, no signup." tool={TOOL_BY_SLUG.get("mega-prompt-builder")!} />} />
          <Route path="/tools/prompt-debugger" element={<LazyPromptDebugger title="Prompt Debugger" toolSlug="prompt-debugger" description="Free prompt debugger: get a health score (0–100), 12+ issue detectors, and instant fix suggestions for any prompt. Fix vague prompts and get better AI answers — private and 100% in-browser." tool={TOOL_BY_SLUG.get("prompt-debugger")!} />} />
          ...
          <Route path="/tools/prompt-chain-builder" element={<LazyPromptChainBuilder title="Prompt Chain Builder" toolSlug="prompt-chain-builder" description="Free prompt chain builder: create 2–5 sequential AI steps with titles, formats, and reordering. See the full workflow and copy it in one click — private, in-browser, no signup." tool={TOOL_BY_SLUG.get("prompt-chain-builder")!} />} />
