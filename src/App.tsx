    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#e2e8f0] w-full">
      ...
      <main className="w-full">
        ...
        <Routes>
          ...
          <Route path="/tools/prompt-debugger" element={<LazyPromptDebugger title="Prompt Debugger" toolSlug="prompt-debugger" description="Free prompt debugger: health score 0-100, 12+ issue detectors, and instant fixes for vague prompts. Get better AI answers — private, in-browser." tool={TOOL_BY_SLUG.get("prompt-debugger")!} />} />
