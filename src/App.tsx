      ...
      <main className="w-full">
        ...
        <Routes>
          ...
          <Route
            ...
            element={
              <LazyPromptOptimizer
                title="Free Advanced Prompt Optimizer"
          ...
          <Route path="/tools/mega-prompt-builder" element={<LazyMegaPromptBuilder title="Mega Prompt Builder" toolSlug="mega-prompt-builder" description="Build complete mega prompts with a free 8-step wizard — role, task, context, audience, format, tone, constraints, and examples. Copy in one click." tool={TOOL_BY_SLUG.get("mega-prompt-builder")!} />} />
          <Route path="/tools/prompt-debugger" element={<LazyPromptDebugger title="Free Prompt Debugger" toolSlug="prompt-debugger" description="Free prompt debugger: health score 0-100, 12+ issue detectors, and instant fixes for vague prompts. Get better AI answers — private, in-browser." tool={TOOL_BY_SLUG.get("prompt-debugger")!} />} />
          <Route path="/tools/security-scanner" element={<LazySecurityScanner title="Free Prompt Security Scanner" toolSlug="security-scanner" description="Scan prompts for injection attacks, jailbreaks, PII leaks, and security threats. Risk level scoring with actionable remediation." tool={TOOL_BY_SLUG.get("security-scanner")!} />} />
          <Route path="/tools/prompt-chain-builder" element={<LazyPromptChainBuilder title="Free Prompt Chain Builder" toolSlug="prompt-chain-builder" description="Free prompt chain builder: create 2-5 sequential AI steps with titles, formats, and reordering. See the full workflow and copy it in one click." tool={TOOL_BY_SLUG.get("prompt-chain-builder")!} />} />
          ...
          <Route path="/tools/api-request-builder" element={<LazyApiRequestBuilder title="Free API Request Builder" toolSlug="api-request-builder" description="Build API requests for OpenAI, Anthropic, and Gemini with model selection, temperature, max tokens, and cURL export." tool={TOOL_BY_SLUG.get("api-request-builder")!} />} />
          ...
          <Route path="/tools/content-summarizer" element={<LazyContentSummarizer title="Free AI Content Summarizer" toolSlug="content-summarizer" description="Summarize articles, reports, and long text into TL;DR, bullets, paragraphs, or academic abstracts with reduction stats." tool={TOOL_BY_SLUG.get("content-summarizer")!} />} />
